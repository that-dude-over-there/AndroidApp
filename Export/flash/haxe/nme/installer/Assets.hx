...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("img/face.png", NME_img_face_png);
			resourceTypes.set ("img/face.png", "image");
			resourceClasses.set ("img/jump.png", NME_img_jump_png);
			resourceTypes.set ("img/jump.png", "image");
			resourceClasses.set ("img/left.png", NME_img_left_png);
			resourceTypes.set ("img/left.png", "image");
			resourceClasses.set ("img/right.png", NME_img_right_png);
			resourceTypes.set ("img/right.png", "image");
			resourceClasses.set ("img/wall.png", NME_img_wall_png);
			resourceTypes.set ("img/wall.png", "image");
