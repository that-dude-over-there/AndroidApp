...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceNames.set ("img/face.png", "img_face_png");
			resourceTypes.set ("img/face.png", "image");
			resourceNames.set ("img/jump.png", "img_jump_png");
			resourceTypes.set ("img/jump.png", "image");
			resourceNames.set ("img/left.png", "img_left_png");
			resourceTypes.set ("img/left.png", "image");
			resourceNames.set ("img/right.png", "img_right_png");
			resourceTypes.set ("img/right.png", "image");
			resourceNames.set ("img/wall.png", "img_wall_png");
